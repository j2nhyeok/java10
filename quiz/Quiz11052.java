...
public class Quiz11052 {
	...
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		System.out.println(min_money(N)); // 카드 N개를 갖기 위해 지불해야 하는 금액의 최댓값을 출력 == 정답

	}
	
	public static int min_money(int n) { // 카드 n개를 갖기위해 지불해야 하는 금액의 최댓값을 출력해주는 메서드
		
		dp[0] = 0; //카드 0개를 갖기 위해 지불해야 하는 금액의 최대값 == 0원
		dp[1] = price[1]; //카드 1개를 갖기 위해 지불해야 하는 금액의 최댓값  == 카드 1개가 담긴 팩의 금액
